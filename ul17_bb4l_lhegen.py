...
# with command line options: Configuration/GenProduction/python/gridpack_generic_cff.py --python_filename ul17_lhegen.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:GEN.root --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands=process.RandomNumberGeneratorService.generator.initialSeed = __SEED1__\nprocess.RandomNumberGeneratorService.externalLHEProducer.initialSeed = __SEED2__\nprocess.MessageLogger.cerr.FwkReport.reportEvery=200 --step LHE,GEN --geometry DB:Extended --era Run2_2017 --no_exec --mc -n __NEVENTS__
