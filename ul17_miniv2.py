...
# with command line options: --python_filename ul17_miniv2.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:MINIv2.root --conditions 106X_mc2017_realistic_v9 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --customise_commands=process.MessageLogger.cerr.FwkReport.reportEvery=200 --step PAT --filein file:RECO.root --era Run2_2017 --runUnscheduled --no_exec --mc -n -1
