...
config.General.requestName     = 'ul16post_bb4l_lhe_from_mini'
...
config.JobType.psetName = 'ul16post_bb4l_lhe_from_mini.py'
...
config.Data.outputDatasetTag = 'RunIISummer20UL16reLHE-bb4l_v2_106X_mcRun2_asymptotic_v13-v1'
