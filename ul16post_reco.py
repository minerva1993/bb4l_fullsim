...
# with command line options: --python_filename ul16post_reco.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:RECO.root --conditions 106X_mcRun2_asymptotic_v13 --customise_commands=process.MessageLogger.cerr.FwkReport.reportEvery=200 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:HLT.root --era Run2_2016 --runUnscheduled --no_exec --mc -n -1
