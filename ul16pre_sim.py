...
# with command line options: --python_filename ul16pre_sim.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:SIM.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands=process.MessageLogger.cerr.FwkReport.reportEvery=200 --step SIM --geometry DB:Extended --filein file:GEN.root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n -1
