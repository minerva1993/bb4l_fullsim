...
config.General.requestName     = 'ul18_sim_EventAwareLumiBased_part1'
...
config.Data.outLFNDirBase = '/store/user/jipark/bb4l_privateSim/CR1ErdOn/UL18/SIM'
config.Data.unitsPerJob = 1000
config.Data.lumiMask = '/data/dust/user/jipark/production/bb4l_studies/bb4l_fullsim/lumimask/nominal_1.json'
