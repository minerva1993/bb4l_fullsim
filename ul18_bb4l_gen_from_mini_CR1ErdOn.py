...
process.RAWSIMoutput.outputCommands.append("drop *_*_*_GEN")
process.RAWSIMoutput.outputCommands.append("drop *_*_*_SIM")
process.RAWSIMoutput.outputCommands.append("drop *_*_*_DIGI2RAW")
process.RAWSIMoutput.outputCommands.append("drop *_*_*_HLT")
process.RAWSIMoutput.outputCommands.append("drop *_*_*_RECO")
process.RAWSIMoutput.outputCommands.append("drop *_*_*_PAT")
process.RAWSIMoutput.outputCommands.append("keep LHEEventProduct_*_*_GEN")
...
#process.generator.externalLHEProducer = cms.InputTag("externalLHEProducer")
#process.externalLHEProducer = cms.InputTag("externalLHEProducer")
