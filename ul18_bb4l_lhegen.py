...
# with command line options: Configuration/GenProduction/python/fragment_bb4l.py --python_filename bb4l_gen_from_lhe.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:GEN.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands=process.RandomNumberGeneratorService.generator.initialSeed = __SEED1__8nprocess.RandomNumberGeneratorService.externalLHEProducer.initialSeed = __SEED2__nprocess.MessageLogger.cerr.FwkReport.reportEvery=200 --step GEN --filein infile.lhe --geometry DB:Extended --era Run2_2018 --no_exec --mc -n __NEVENTS__
