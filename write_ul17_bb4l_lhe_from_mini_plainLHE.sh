BASE="/pnfs/desy.de/cms/tier2/store/user/jipark/bb4l_privateSim/LHE_nominal/BBLLNuNu_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL17reLHE-bb4l_v2_106X_mc2017_realistic_v6-v1/260505_130056"
...
cat > job.sub << EOF
JobBatchName = "ul17_bb4l_lhe_from_mini_plainLHE"
...
Args        = "UL17 /pnfs/desy.de/cms/tier2/store/user/jipark/bb4l_privateSim/LHE_nominal/BBLLNuNu_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL17reLHE-bb4l_v2_106X_mc2017_realistic_v6-v1/260505_130056 \$(A) \$(B)"
+RequestRuntime = 3600
RequestMemory = 2048
RequestCpus = 1
