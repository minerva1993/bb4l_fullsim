...
input_file = "template_bb4l_widthWIDTH_gen_to_sim_ERA"
output_file = "template_bb4l_widthWIDTH_gen_to_sim_ERA".replace("template", "submit").replace("WIDTH", options.width).replace("ERA", options.year)
