...
options.register ('nEvents', 1000, VarParsing.multiplicity.singleton, VarParsing.varType.int, "The number of events to process; workaround to avoid hardcoded tag in Varparsing")
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        pythia8BBBar4lSettings = cms.vstring(
            ...
            #for top recoil test, these are actually default values
            'TimeShower:recoilStrategyRF = 0',
            'TimeShower:weightRF = 1.',
            'TimeShower:recoilRFUseParents = off'
        ),
