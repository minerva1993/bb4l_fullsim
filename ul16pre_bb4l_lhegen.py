...
# with command line options: Configuration/GenProduction/python/gridpack_generic_cff.py --python_filename ul16pre_lhegen.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:GEN.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands=process.RandomNumberGeneratorService.generator.initialSeed = __SEED1__\nprocess.RandomNumberGeneratorService.externalLHEProducer.initialSeed = __SEED2__\nprocess.MessageLogger.cerr.FwkReport.reportEvery=200 --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n __NEVENTS__
...
#options.register ('skip', 0, VarParsing.multiplicity.singleton, VarParsing.varType.int, "The number of events to skip initially")
...
#    fileNames = cms.untracked.vstring ('file:LHE.lhe'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/13TeV/powheg/bb4l/b_bbar_4l_slc7_amd64_gcc700_CMSSW_10_6_39_bb4l_dl_nominal_allflavors_v2_noPDFWeights.tgz'),
...
process.RandomNumberGeneratorService.generator.initialSeed = 123456
